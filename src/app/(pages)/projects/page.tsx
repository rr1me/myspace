	...
	return (
		<article className={s.projects}>
			...
			>
				...
				Includes sequential animations and deep authorization, based on Refresh-Access tokens that was built on top of two databases:
				PostgreSQL as true and Redis for frequent requests. Auth system based on roles and has email confirmation through SMTP,
